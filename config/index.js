export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx40945564254b7fd1",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5a7e8434633d877839271860ca612736",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "4-ld00i7iAYfUDC3xlcKdQ5pc70EoGfg0ojlj4RCLRk",
      // 所在省份
      province: "安徽",
      // 所在城市
      city: "安庆",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "兰兰", "year": "2003", "date": "12-05"},
        {"type": "*生日", "name": "涛涛", "year": "2001", "date": "08-28"},
        {"type": "节日", "name": "纪念日", "year": "2022", "date": "08-25"},
